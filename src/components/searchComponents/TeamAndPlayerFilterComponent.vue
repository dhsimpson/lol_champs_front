<template>
    <button id="team-player-filter" @click="setModalName(modalName)">
...
export default {
    ...
    data() {
        return {
            // showModal: false,
            // modalName: 'teamPlayerFilterModal'
        }
    },
    setup() {
        const {showModal, modalName, currModalName, setModalName, isShowModal} = atomicModal('teamPlayerFilterModal');
