<template>
    ...
    <teleport v-if="currModalName==modalName" to="#team-player-filter" :disabled="false">
        <team-player-modal/>
    </teleport>
</template>
...
export default {
    ...
    computed: {
        ...mapGetters({
            currModalName: 'GET_OPEN_ATOMIC_MODAL_NAME'
        })
    },
    methods: {
        ...mapMutations({
            setModalName: 'SET_OPEN_ATOMIC_MODAL_NAME'
        })
    }
}
</script>
